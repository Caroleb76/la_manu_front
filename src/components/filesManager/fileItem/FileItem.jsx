    ...
    >
      ...
      {fileClicked && (
        <div className={styles.options}>
          <p onClick={onDownloadClicked}>
            Telecharger <Icon icon="material-symbols:download-rounded" />
          </p>
          <p onClick={() => setDeleteFileConfirmation(true)}>
            Supprimer <Icon icon="material-symbols:delete-rounded" />
          </p>
        </div>
      )}
    </div>
