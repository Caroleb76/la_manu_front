      ...
      if (userData) {
        reset({
          ...
          birthDate: userData.birthDate
            ? convertDateToStandardString(new Date(userData.birthDate))
            : "",
        ...
        setUser(userData);
        const formattedInitials = handleNameInitials(
      ...
      <form onSubmit={handleSubmit((data) => onSubmit(data))}>
        <section className={`${styles.grid} ${styles.profileSection}`}>
          <div className={styles.profileIconTitleWrapper}>
            <input
              ...
              onChange={(e) => {
                ...
                setFiles((prev) => [
                  ...prev,
                  { name: "profilePicture", file: e.target.files[0] },
                ]);
              }}
            />
            ...
            {errors.avatar && (
              <p className="inputError">{errors.avatar?.message}</p>
            )}
          ...
          <InputText
            ...
            {...register("birthName")}
            error={errors.birthName?.message}
          />
          <InputText
            label="Nom d'usage"
            {...register("lastName")}
