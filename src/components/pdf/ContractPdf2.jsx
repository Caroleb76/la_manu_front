                ...
                {currentContract && (
                    ...
                    <div>
                        ...
                        <p style={styles.p}>
                            ...
                            cadre de la formation: <span style={{ fontWeight: "bold", fontSize: "16px" }}>
                        ...
                        <p style={styles.h4}>
                            Respect des engagements de la
                            démarche Qualiopi  : </p>
                        <p style={styles.p}>

                            <li>Le salarié doit transmettre au
                                ...
                                par le formateur coordinateur. </li>
                            <li>Le salarié autorise l’IFEN à transmettre ses supports aux apprenants
                                inscrits sur l’action de formation concernée. </li>
                            <li>Le salarié s’engage à respecter les attendus figurant
                                dans le livret de l’intervenant. </li>
                        </p>
                        <br />
                        <p style={styles.p}>
                            <span style={{ fontStyle: "italic", fontSize: "11px" }}>
                                ...
                                dossier, leur seront transmises.</span>  <br /><br />
                            Merci de signer ce contrat, de valider votre intervention une fois qu'elle sera réalisée et de nous transmettre les justificatifs de frais le cas échéant au plus tard
                            le 17 de chaque mois pour un paiement du salaire le 30.
                        </p>
                        <br />
                        <p >
                            Contrat établi le{" "}
                        ...
                        <br />
                        <div style={{ display: "flex", justifyContent: "space-around", alignItems: "center", marginright: "2rem", marginBottom: "5rem" }}>
