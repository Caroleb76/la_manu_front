...
async function getById(userId) {
  const response = await apiClient("interventions/id/" + userId, {
    method: "GET",
  });
  return response;
}
...
async function getByUserId(id) {
  ...
  const response = await apiClient("interventions/user/" + id, {
    method: "GET",
    params,
  });
  return response;
...
async function getInterventionsByContractId(contractId) {
  ...
  const response = await apiClient(`interventions/contract/${contractId}`, {
    method: "GET",
  });
  return response;
}
...
async function validateIntervention(interventionId) {
  const response = await apiClient(`interventions/validate/${interventionId}`, {
    method: "POST",
  });
...
async function createIntervention(intervention) {
  const response = await apiClient("interventions/", {
    method: "POST",
    body: intervention,
  });
  return response;
...
async function getTotalHoursPerCategory() {
  const response = await apiClient(`interventions/categories/hours`, {
    method: "GET",
  });
  return response;
}
async function getTotalAmountPerMonth() {
  ...
  const response = await apiClient(`interventions/monthlyAmount/` + date, {
    method: "GET",
  });
  return response;
}
...
async function getTotalExtraCostPerMonth() {
  const date = dayjs(new Date()).format("YYYY-MM-DD");
  const response = await apiClient(`extraCosts/monthlyAmount/` + date, {
    method: "GET",
  });
...
async function validatePayment(interventionId) {
  const response = await apiClient(
    `interventions/validatePayment/${interventionId}`,
    { method: "PUT" },
  );
  return response;
}
